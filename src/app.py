...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team for league play and training",
    ...
    "Art Club": {
        "description": "Explore visual arts, painting, and drawing",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": []
    },
    "Drama Club": {
        "description": "Acting, improv, and stage production",
...
def get_activity(activity_name: str):
    """Return an activity by name or raise a clear API error."""
